...
public class TimingTest {
     ...
     * @param margin The difference between the minimum and maximum time in which the runnable should
     *     run. This is to account for inaccuracies in cpu time slices.
