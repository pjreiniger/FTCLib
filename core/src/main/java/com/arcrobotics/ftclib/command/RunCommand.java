 ...
 * use {@link Command#withTimeout(long)} or {@link Command#interruptOn(BooleanSupplier)} to give it
 * one. If you only wish to execute a Runnable once, use {@link InstantCommand}.
 */
