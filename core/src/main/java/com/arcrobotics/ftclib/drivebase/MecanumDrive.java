...
public class MecanumDrive extends RobotDrive {
    ...
    public void driveWithMotorPowers(
            double frontLeftSpeed, double frontRightSpeed, double backLeftSpeed, double backRightSpeed) {
        motors[MotorType.kFrontLeft.value].set(frontLeftSpeed * maxOutput);
        motors[MotorType.kFrontRight.value].set(frontRightSpeed * rightSideMultiplier * maxOutput);
        motors[MotorType.kBackLeft.value].set(backLeftSpeed * maxOutput);
        motors[MotorType.kBackRight.value].set(backRightSpeed * rightSideMultiplier * maxOutput);
    }
}
