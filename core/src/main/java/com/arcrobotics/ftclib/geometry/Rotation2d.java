...
public class Rotation2d implements Interpolatable<Rotation2d> {
     ...
     * @see com.arcrobotics.ftclib.util.MathUtil#angleModulus(double) to constrain the angle within
     *     (-pi, pi]
     */
     ...
     * @see com.arcrobotics.ftclib.util.MathUtil#inputModulus(double, double, double) to constrain the
     *     angle within (-180, 180]
     */
